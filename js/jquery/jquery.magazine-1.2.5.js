...
Galleria = function() {
    ...
    // add some elements
    var divs =  'container contentsHeading stage images image-nav image-nav-left image-nav-right ' +
                'info info-text info-title info-description ' +
                'thumbnails thumbnails-list thumbnails-container thumb-nav-left thumb-nav-right ' +
                'image-nav-bar image-nav-bar-left image-nav-bar-right '+
                'loader counter tooltip',

        spans = 'current total contentsDate contentsHeadingSpan';
        ...
        init : function() {
            ...
            var elems = 'overlay box content shadow title info close prevholder prev nextholder next counter image',
                ...
                cssMap = {
                    ...
                    shadow:     abs+'background:#fff;width:100%;height:100%;',
                    content:    abs+'background-color:#fff;top:10px;left:10px;right:10px;bottom:10px;overflow:hidden',
                    info:       abs+'bottom:10px;left:250px;right:295px;color:#444;font:11px/13px arial,sans-serif;height:13px',
    ...
    */
    ...
    _init: function() {
        ...
        this.append({
            ...
            'thumbnails-container' :
                ['contentsHeading', 'thumb-nav-left', 'thumbnails-list', 'thumb-nav-right'],
            'container' :
        ...
        this.$( 'contentsHeading' ).append('<h2>'+heading_title+'</h2><span class="span_date">' +fullDate+'</span><br><span class="mag_two">SAYI 3</span>');
        ...
        this.$('container').css({"width":"952px", "height":"661px"});
        ...
        /*navigation in bar*/
                // bind image navigation arrows
        this.$( 'image-nav-bar-right, image-nav-bar-left' ).bind( 'click', function(e) {
        ...
        $.each( ['info','counter','image-nav','image-nav-bar'], function( i, el ) {
    ...
    _createThumbnails : function() {
        ...
        for( i = 0; this._data[ i ]; i++ ) {
            ...
            if(order_array[i]!=''){
                var position_chk=order_array[i];
            }else{
                var position_chk=i;
            }
...
//            var position_chk=order_array[i];
            ...
            if ( o.thumbnails === true ) {
                ...
                //src =img_dir+"magazine/thumb/bm21.jpg";
            ...
            $( thumb.container ).add( o.keepSource && o.linkSourceImages ? data.original : null )
                .data('index', position_chk).bind( o.thumbEventType, onThumbEvent );
