...
class OrderDetailCore extends ObjectModel
{
	...
	/** @var integer */
	public $product_quantity_exchanged;
	...
	'product_quantity_exchanged' => 'isUnsignedInt',
	...
	public function getFields()
	{
		...
		$fields['product_quantity_exchanged'] = (int)($this->product_quantity_exchanged);
	...
	public static function getDetailIdsByOrderId($id_order) {
		$sql = 'SELECT id_order_detail FROM `'._DB_PREFIX_.'order_detail`
			WHERE `id_order`= '.$id_order;
		$result = Db::getInstance(_PS_USE_SQL_SLAVE_)->ExecuteS($sql);

		foreach ($result as &$item) {
			 $item = (int) $item['id_order_detail'];
		}
