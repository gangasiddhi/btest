	...
	protected function _assignAddress()
	{
		...
		if (Validate::isLoadedObject($customer))
		{
			...
			foreach($customerAddresses as $address)
			{
				...
				$formatedAddressFieldsValuesList[$address['id_address']]['ordered_fields'][6] = 'state';
				$formatedAddressFieldsValuesList[$address['id_address']]['ordered_fields'][7] = 'province';
				$formatedAddressFieldsValuesList[$address['id_address']]['ordered_fields'][8] = 'Country:name';
				$formatedAddressFieldsValuesList[$address['id_address']]['ordered_fields'][9] =	'phone';
				...
				$formatedAddressFieldsValuesList[$address['id_address']]['formated_fields_values']['state'] = State::getNameById((int)$address['id_state']);
				//$formatedAddressFieldsValuesList[$address['id_address']]['formated_fields_values']['province'] = Province::getProvinceNameById((int)$address['id_province']);
