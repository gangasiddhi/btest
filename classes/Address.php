...
class AddressCore extends ObjectModel
{
	...
	protected	$fieldsSize = array('alias' => 32, 'company' => 32, 'lastname' => 32, 'firstname' => 32,
									'address1' => 128, 'address2' => 128, 'postcode' => 12,
	...
	protected	$fieldsValidate = array('id_customer' => 'isNullOrUnsignedId', 'id_manufacturer' => 'isNullOrUnsignedId',
										'id_supplier' => 'isNullOrUnsignedId', 'id_country' => 'isUnsignedId', 'id_state' => 'isNullOrUnsignedId','id_province'=>'isNullOrUnsignedId',
	...
	public function __get($key) {
		if ( $key == 'provinceName' ) {
			return Province::getProvinceNameById($this->id_province);
		}
	}
	...
	public function add($autodate = true, $nullValues = false)
	{
		...
		$address1 = str_replace(array(', <br />',',<br />','<br />'), ', ', $address1);
	...
	*/
	...
	public function getFields()
	{
		...
		$fields['id_province'] = (int)($this->id_province);
