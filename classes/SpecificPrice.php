...
class SpecificPriceCore extends ObjectModel
{
	...
	public	$to;
 	...
 	protected 	$fieldsRequired = array('id_product', 'id_shop', 'id_currency', 'id_country', 'id_group', 'price', 'from_quantity', 'reduction', 'reduction_type', 'strike_out', 'from', 'to');
 	protected 	$fieldsValidate = array('id_product' => 'isUnsignedId', 'id_shop' => 'isUnsignedId', 'id_country' => 'isUnsignedId', 'id_group' => 'isUnsignedId', 'price' => 'isPrice', 'from_quantity' => 'isUnsignedInt', 'reduction' => 'isPrice', 'reduction_type' => 'isReductionType', 'strike_out'=> 'isInt', 'from' => 'isDateFormat', 'to' => 'isDateFormat');
	...
	public function getFields()
	{
		...
		$fields['strike_out'] = (int)($this->strike_out);
