...
<div id="join-now">
    {*<div id="join_form">*}
        ...
        <form method="post" id="new_user" class="new_user" action="{$link->getPageLink('surveyvsregister.php')}" {*onsubmit="return acceptCGV('{l s='Please accept the terms of service before the next step.' js=1}');"*}>
            ...
            <div style="float:left; width:100%">
                    ...
                    <input type="submit" name="submitAccount" id="submitAccount" class="buttonlarge pink" value="{l s='hemen katil'}" />
            </div>
