<div id="{if isset($child_categories) || $category->name == 'DiscountOutlet'}product_list{else}productList{/if}">
    {if isset($products)}
        {foreach from=$products item=product name=products}
            <div class="showroom_sel_cntnr gridItem_{$product.id_product} {*$showroom_with_size*}">
    ...
    <script type="text/javascript">
        (function(d){ldelim}
			...
			HEIAS_PARAMS.push(['order_article','{foreach name=productLoop item=product from=$products}{$product.id_product}{if ! $smarty.foreach.productLoop.last},{/if}{/foreach}']);
