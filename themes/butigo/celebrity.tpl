...
<div class="celebrity_wrapper">
	{$HOOK_CELEBRITY_SLIDE_SHOW}

	<h2>{l s='Champagne and Caviar'}</h2>

	{if isset($all_celebrity_products) AND $all_celebrity_products}
	<div id="all_celebrity_products" class="container_lookbook">
		{foreach from=$all_celebrity_products item=product name=Celebrity_products}
