...
<div class="style_survey">
	...
	<div id="quiz">
		...
		<div class="inner">
			...
			<form id="quiz_form" name="quiz_form" method="post" action="{$link->getPageLink('fb-stylesurvey.php')}?stp=3" style="margin: 0pt; padding: 0pt;">
...
{if $step_count == 1 && $login == 1}
<script type="text/javascript">
//<![CDATA[
{literal}
	$(document).ready(function() {
		$.fancybox('<div style="padding:30px;">Butigo\'da daha önceden üyeliğiniz bulunuyor.<a href="{/literal}{$link->getPageLink('authentication.php')}{literal}"><span id="fb_sign"> Buraya tıklayarak giriş yapınız.</span></a></div>',
		{
			'autoSize' : false,
			'width' : 'auto',
			'height' : 'auto',
			...
			'showNavArrows' : false,
			'onClosed': function() {
				window.location = "{/literal} {$link->getPageLink('index.php')} {literal}"
			}
		});
