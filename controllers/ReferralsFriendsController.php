...
class ReferralsFriendsControllerCore extends FrontController
{
	public $ssl = false;
	public $php_self = 'referrals-friends.php';
	...
	public function preProcess()
	{
		...
		if (!$from_sailthru_spider) {
			if (!self::$cookie->isLogged())
				Tools::redirect('authentication.php?back=referrals-friends.php');
		...
		self::$smarty->assign(array(
			'HOOK_REFERRAL_PROGRAM' => Module::hookExec('referralProgram')
		));
	...
	public function displayContent()
	{
		...
		self::$smarty->display(_PS_THEME_DIR_.'referrals-friends.tpl');
	}
