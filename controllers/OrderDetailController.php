		...
		else
		{
			...
			//	$stateInvoiceAddress = new State((int)$addressInvoice->id_state);
				...
				$dlv_adr_fields = AddressFormat::getOrderedAddressFields($addressDelivery->id_country);
                                /*to fix IE7 issue*/
                                    $notrequiredaddressfields = array('company','vat_number', 'address2', 'postcode city','province');
                                /*to fix IE7 issue*/
                                $dlv_adr_fields =  array_diff($dlv_adr_fields, $notrequiredaddressfields);
				...
				self::$smarty->assign(array(
					...
					'shipment_tracking_url' => $order->getTrackingLink(),
