...
class OrderOpcControllerCore extends ParentOrderController
{
				...
				if (Tools::isSubmit('method'))
				{
					switch (Tools::getValue('method'))
					{
						...
						case 'getAddressBlockAndCarriersAndPayments':
							...
							die(Tools::displayError('Error: 201306051532'));
							break;
						case 'makeFreeOrder':
						...
						case 'updateAddressesSelected':
							...
							die(Tools::displayError('Error: 201306051533'));
							break;
						default:
							exit;
					}
	...
	public function setMedia()
	{
		...
		Tools::addJs(_PS_JS_DIR_.'jquery/jquery.scrollTo.min.js');
	...
	protected function _getGuestInformations()
	{
		...
		return array(
			...
			'city' => Tools::htmlentitiesUTF8(Province::getProvinceNameById($address_delivery->id_province)),
