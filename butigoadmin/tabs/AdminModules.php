...
class AdminModules extends AdminTab
{
	...
	public function displayJavascript()
	{
		...
		echo '<script type="text/javascript" src="'._PS_JS_DIR_.'jquery/jquery.autocomplete.js"></script>
			<script type="text/javascript" src="'._PS_JS_DIR_.'jquery/jquery.fancybox.pack.js"></script>
	...
	public function displayList()
	{
		...
		echo '<link href="'._PS_CSS_DIR_.'jquery.fancybox.css" rel="stylesheet" type="text/css" media="screen" />';
