...
if($ && Pitchdeck)
{
	...
	Pitchdeck.attach('problem',
	{
		init: function()
		{
			...
			$('#problem .columns-container .column ul').each(function()
			{
		...
		keyframes:
		{
			0:
			{
				...
				'#problem .columns-container .column ul li': { opacity:0 },
			},
			...
			90:
			{
				...
				'#problem .columns-container .column ul li': { opacity:1 },
		...
		events:
		{
			'#problem .columns-container .column > ul > li':
			{
				click:
				[
					function()
