			...
			<table class="std">
				...
				<tr>
					...
					<td class="align_center">
						<a href="{$base_dir_ssl}modules/mailalerts/myalerts.php?action=delete&id_product={$product.id_product}{if $product.id_product_attribute}&id_product_attribute={$product.id_product_attribute}{/if}"><img src="{$modules_dir}mailalerts/img/delete.gif" alt="{l s='Delete' mod='mailalerts'}" /></a>
					</td>
				</tr>
				</tbody>
			{/foreach}
