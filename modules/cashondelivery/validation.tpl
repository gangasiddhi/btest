...
<form action="{$this_path_ssl}validation.php" method="post"
    ...
    <div class="check-agree">
        ...
        <a class="agree" id="agreement1" title="Pre Sales Agreement"
            href="{$base_dir_ssl}agreements.php?id_cms=20&content_only=1&cod=1">Ön-satış sözleşmesini</a>&nbsp;ve&nbsp;<a
                class="agree" id="agreement2" title="Sales Agreement"
    ...
    <div class ="payment_details">
        <div class ="final_price">
            ...
            <span class="cart_total_label">({l s='Tax Included' mod='cashondelivery'})</span>
    ...
    <div id="submit-payment">
        ...
        <input type="submit" name="submit" value="{l s='CheckOut' mod='cashondelivery'}"
            class="buttonmedium blue checkOut" style="top:105px" />
        <input type="text" name="orderProcessing" class="buttonmedium blue checkOut hidden"
