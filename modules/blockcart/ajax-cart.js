...
*/
/*****************************************************************************************
 *Please Don't delete any of the commented code while optimization..
 *****************************************************************************************/
...
var ajaxCart = {
	...
	refresh : function(){
        //dont send ajax request to cart page
        if (!window.location.pathname.match(/^\/siparis/)) {
            return true;
        }
