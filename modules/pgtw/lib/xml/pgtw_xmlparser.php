...
(
  ...
  * pgtw_XmlParser returns an empty params array if it encounters
  * any error during parsing
  */
  // XML to Array
  class pgtw_XmlParser {
    ...
    */
    function pgtw_XmlParser($input/*, $xmlParams=array(XML_OPTION_CASE_FOLDING => 0)*/) {
