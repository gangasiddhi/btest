...
class PGYResponse {
     ...
     */
    function PGYResponse($id = null, $name = null, $key = null) {
        $this->merchant_id = $id;
    ...
    function SendAck($die = true) {
        ...
        $acknowledgment = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
            . "<notification-acknowledgment xmlns=\"" . $this->schema_url . "\"/>";
    ...
    function GetParsedXML($request = null) {
        if (! is_null($request)) {
            ...
            $this->xml_parser = new pgy_XmlParser($request);
