...
$(document).ready(function(){
	...
	$('#recommend-categories-treeview li input[type="checkbox"]:checked').trigger('click');
	...
	$("#recommend-categories-treeview").treeview({
		url : 'ajax.php',
	...
	$('#recommend-categories-treeview li#1 span').trigger('click');
...
function clickOnCategoryBox(category)
{
	if (category.is(':checked'))
	{
		...
		/*To display product in the checked category, this function is defined in product-recommend.js */
		showProductsInTheCategory(category.val());
	}
	else
	{
