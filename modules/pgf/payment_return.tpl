...
<div class="shopping-cart">
    <div id="order-conf">
        {*<img src="{$img_dir}cart/shopping-success.gif" alt="{l s='Confirmation Message' mod='pgf'}"/>*}
         ...
         {*<div id="social-network" class="order-success-social-link">
            <ul>
                <li><h4>{l s='HAPPY WITH PURCHASE' mod='pgf'}&nbsp;?&nbsp;&nbsp; <span>{l s='SHARE IT' mod='pgf'}&nbsp;!</span></h4></li>
    ...
    <div id="order-detail-content" class="table_block">
        <table id="order_summary">
            <thead>
                <tr>
                    <th class="order_product item">{l s='Product' mod='pgf'}</th>
                    <th class="order_quantity item">{l s='Qty' mod='pgf'}</th>
                    <th class="order_unit item">{l s='Unit price' mod='pgf'}</th>
                    <th class="order_total last_item">{l s='Total' mod='pgf'}</th>
                </tr>
            </thead>
            ...
            <tfoot>
                <tr class="order_total_price">
                    <td colspan="3" class="order_total_label">
                        {l s='Total' mod='pgf'}
                        &nbsp;
                        <span>({l s='Tax Incl.' mod='pgf'})</span>
                    </td>
            ...
            <tbody>
                            ...
                            <tr class="alternate_item cart_item">
                                ...
                                <td class="cart_quantity">
                                    <a class="cart_quantity_delete"
                                        ...
                                        <img src="{$img_dir}icon/delete.gif" alt="{l s='Delete' mod='pgf'}" title="{l s='Delete this customization' mod='pgf'}"
                                    ...
                                    <a class="cart_quantity_up" href="{$base_dir_ssl}cart.php?add&amp;id_product={$product.id_product|intval}&amp;ipa={$product.id_product_attribute|intval}&amp;id_customization={$id_customization}&amp;token={$token_cart}"
                                        title="{l s='Add' mod='pgf'}">
                                        <img src="{$img_dir}icon/quantity_up.gif" alt="{l s='Add' mod='pgf'}" width="14" height="9" />
                                    </a>
                                    ...
                                    <a class="cart_quantity_down" href="{$base_dir_ssl}cart.php?add&amp;id_product={$product.id_product|intval}&amp;ipa={$product.id_product_attribute|intval}&amp;id_customization={$id_customization}&amp;op=down&amp;token={$token_cart}"
                                        title="{l s='Subtract' mod='pgf'}">
                                        <img src="{$img_dir}icon/quantity_down.gif" alt="{l s='Subtract' mod='pgf'}" width="14" height="9" />
                                    </a>
                                </td>
                ...
                {if $order->total_shipping != 0}
                    <tr class="shipping_cost">
                        <td colspan="3" class="shipping-label">{l s='Shipping Cost' mod='pgf'}</td>
                ...
                {if $order->installment_count > 1}
                    <tr class="installment-details">
                        <td colspan="3" class="installment-label">{l s='Interest Amount' mod='pgf'}&nbsp;({$order->installment_count}&nbsp;{l s='Installments' mod='pgf'})</td>
